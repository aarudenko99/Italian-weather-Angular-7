 ...
 * Copyright (c)  2014  Brian Hadaway; Licensed MIT */(function($, window, document, undefined) {
    ...
    IosList.prototype = {
        ...
        init: function(options) {
            ...
            this.$fakeHeader.html(this.elems[0].headerText);

            this.$listWrapper.scroll(function() {
                window.requestAnimationFrame(function(){scope.testPosition();});
            });
        ...
        testPosition: function() {
            ...
            if (topElement) {
                this.$fakeHeader.html(topElement.headerText);
            }
        }
    };
